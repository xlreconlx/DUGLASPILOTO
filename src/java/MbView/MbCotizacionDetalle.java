...
public class MbCotizacionDetalle {
    ...
    public MbCotizacionDetalle() {
       ...
       public List<Cotizaciondetalle> getAll() {
        ...
        public void BuscarBYcodigoFactura(Cotizacion cotiza) {
        this.listaCotizaciondetalle = new ArrayList<>();
        this.session = null;
        this.transaccion = null;
        try {
      ...
      this.listaCotizaciondetalle.clear();
        FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Error", "el id es" + cotiza.getIdcotizacion()));
            this.listaCotizaciondetalle.addAll(daoCotizacionDetalle.getAllByIdCotizacion(this.session, cotiza.getIdcotizacion()));
