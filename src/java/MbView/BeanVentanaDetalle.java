...
public class BeanVentanaDetalle {
    ...
    public void BuscarBYcodigoFactura(Facturas factu) {
        ...
        try {
            ...
            FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Error", "el id es" + factu.getIdfacturas()));
            this.listaVentanadetalleSele.addAll(daoDetalle.getAllByIdFactura(this.session, factu.getIdfacturas()));
