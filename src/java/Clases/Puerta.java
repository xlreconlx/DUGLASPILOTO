...
public class Puerta {
    ...
    public Puerta(String ancho, String alto, int preTrabajo, int preDescuento, int preAluminiot87, int preAluminio3,
            int prePartidorT103, int prePisavidrios,  int prePerfilU71, int tipoPuerta,
            int preEntamborado, int preEntamboradoF06, int preAlamoUnoMedia,  int preEmpaque) {
        ...
        switch (tipoPuerta) {
            ...
            //           con este codigo fabricamos una puerta de aluminio t87 con vidrio
            case 1:
                //marco de la pared
            ...
            //           con este codigo fabricamos una puerta de aluminio t103 entamborada con perfil u71 sin partidor en el centro
            case 2:
                //marco de la pared
                this.aluminio3 = this.alto * 2 + this.ancho * 1;
                //marco puerta
            ...
            //    con este codigo fabricamos una puerta de aluminio t87 entamborada con perfil f06 sin partidor en el centro
            case 3:
                //marco de la pared
                this.aluminio3 = this.alto * 2 + this.ancho * 1;
                //marco puerta
            ...
            case 4:
                //    con este codigo fabricamos una puerta de aluminio t103  con partidor t103 en el centro
                //marco de la pared
                this.aluminio3 = this.alto * 2 + this.ancho * 1;
            ...
            case 5:
                    //    con este codigo fabricamos una puerta de aluminio t103 con perfil alamo de 1 1/2 con partidor t103 en el centro
                //marco de la pared
                this.aluminio3 = this.alto * 2 + this.ancho * 1;
