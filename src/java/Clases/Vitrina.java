...
public class Vitrina {
    ...
    private int precioEmpaque;
     ...
     public Vitrina(String ancho, String alto, String fondo, int preTrabajo, int preDescuento,
            int preCuartoCirculo, int preAnguloMedia, int preNaveDvisionBano, int preCarrileras, int prePerfilEsquineroUna,
            int preTubularUna, int preEmpaqueUnaMedia, int preEmpaqueUna, int tipoVitrinas) {
        ...
        switch (tipoVitrinas) {
            ...
            case 1:
                ...
                this.empaque = (this.ancho * 2) * preEmpaqueUnaMedia;

                this.sumaTotal = this.precioCuartoCirculo + this.precioAnguloMedia
                 + this.precioCarrileras + this.precioNaveDivicionBano;
            ...
            case 2:
                ...
                this.precioNaveDivicionBano = this.naveDivisionBano * preNaveDvisionBano;
                this.precioEmpaque = this.empaque * preEmpaqueUnaMedia;

                this.sumaTotal = this.precioPerfilEsquineroUna + this.precioTubularUna
                + this.precioNaveDivicionBano + this.precioAnguloMedia   + this.precioEmpaque;
            ...
            case 3:
                ...
                this.empaque = (this.ancho * 2) * preEmpaqueUna;
                this.precioPerfilEsquineroUna = this.perfilEsquineroUna * prePerfilEsquineroUna;
                this.precioTubularUna = tubularUnaAleta * preTubularUna;
                this.precioAnguloMedia = this.anguloMedia * preAnguloMedia;
